 ...
 * Output File Name
 *
 * Returns output filename (excluding path).
 *
 * eg.
 *     /scripts/foo.coffee  => foo.js
 *     foo.css.sass  => foo.css
 */

var outputFileName = exports.outputFileName = function(source){
  return getCurrent(source).source + "." + outputType(source)
}
 ...
 *
 * Returns the corresponding file name of the source map.
 *
 * eg.
 *     /scripts/foo.coffee  => foo.js.map
 *     foo.css.sass  => foo.css.map
 */

var sourceMapFileName = exports.sourceMapFileName = function(source){
  return outputFileName(source) + ".map"
}
